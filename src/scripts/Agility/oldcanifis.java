...
public class oldcanifis extends PollingScript<ClientContext> implements PaintListener {
    ...
    public void start() {
        ...
        obList.add(new Obstacle("Climb", 10819, 3501, 3492,3512,3485,0));
        obList.add(new Obstacle("Jump", 10820,3511, 3489, 3504, 3496, 2));
        obList.add(new Obstacle("Jump", 10821,3503, 3506,3497, 3504, 2));
        ...
        switch (getState()) {
            case ACTION:
                for (Obstacle o : obList) {
                    if (o.bound.contains(ctx.players.local())) currOb = obList.indexOf(o);
                }
