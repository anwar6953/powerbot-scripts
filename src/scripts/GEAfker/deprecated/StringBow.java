...
public class StringBow extends Task<ClientContext> {
...
//            }
            ...
            resourceLeft2 = temp;            if (limit < min(resourceLeft1, resourceLeft2) && limit == 0) limit = min(resourceLeft1, resourceLeft2);
